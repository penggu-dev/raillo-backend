...
import com.sudo.raillo.batch.application.dto.StationFareData;
import com.sudo.raillo.batch.application.dto.StationFareHeader;
import com.sudo.raillo.batch.application.service.StationService;
import com.sudo.raillo.batch.infrastructure.StationFareRepository;
import com.sudo.raillo.batch.infrastructure.excel.StationFareParser;
...
public class StationFareBatchFacade {
	...
	private void persistStationFare(Set<StationFareData> stationFareData) {
		...
		stationFareData.forEach(data -> {
			...
			stationFares.add(StationFare.create(
				departureStation,
				arrivalStation,
				BigDecimal.valueOf(data.standardFare()),
				BigDecimal.valueOf(data.firstClassFare())
			));
