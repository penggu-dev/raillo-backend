...
import com.sudo.raillo.batch.application.dto.ScheduleStopData;
import com.sudo.raillo.batch.application.dto.TrainData;
import com.sudo.raillo.batch.application.dto.TrainScheduleData;
import com.sudo.raillo.batch.application.facade.OperatingDayUtil;
...
public class TrainScheduleParser extends ExcelParser {
	...
	@Value("${train.schedule.excel.location}")
