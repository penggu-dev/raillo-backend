...
@Tag(name = "CartReservations")
public interface CartReservationControllerDoc {
	...
	SuccessResponse<?> createCartReservation(CartReservationCreateRequest request, UserDetails userDetails);
	...
	SuccessResponse<List<ReservationDetail>> getCartReservations(@AuthenticationPrincipal UserDetails userDetails);
}
