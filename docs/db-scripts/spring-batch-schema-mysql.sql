-- Spring Batch 6.0.4 official MySQL metadata schema.
-- Apply once to the Raillo database before deploying raillo-batch.
...
CREATE TABLE BATCH_STEP_EXECUTION_SEQ (
	...
	CONSTRAINT BATCH_STEP_SEQ_UN UNIQUE (UNIQUE_KEY)
) ENGINE=InnoDB;
